...
【补充问题2】
假设农场中成熟的母牛每年只会生1头小母牛，并且永远不会死。第一年农场中有一只成熟的母牛，从第二年开始，母牛开始生小母牛。
...
class CowProblem {
public:
    static unsigned long cow_number(unsigned int year);
    static unsigned long cow_number_opt(unsigned int year);
};
